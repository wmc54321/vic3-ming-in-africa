...
当前版本为 **0.1.5**，支持《Victoria 3》**1.13.x**。实际可加载文件位于 `mod/ming_in_africa`。
...
- 从专属“两个中华”开局目标选择明或清，以战争、臣属关系或政治趋同处理两朝并立。
- 迁都、重建国家、收复中华故土，并争夺可叠加的两所国子监，以及“广州十三行”和“靖海市舶总行”两座海贸奇观。
- 设立“坤舆矿务总局”，统筹煤、铁、硫、铅、金矿业，并以“龙印精铁”建立大明的近代矿务标准。
- 面向非洲、亚洲腹地与海外领土的中华属特许公司。
- 专属主菜单、文化、法律、政体地名、战争目标、建筑、旗帜与中英文本地化。

## 兼容性

- 支持游戏版本：`1.13.*`
- DLC：没有强制 DLC 要求；“坤舆矿务总局”本体可无 DLC 使用，其产业特许扩展与“龙印精铁”需要《Charters of Commerce》对应功能。
- 本 mod 替换 `common/history/states`，通常不兼容其他修改 1836 年州所有权、开局国土或州历史的 mod。
- 本 mod 同名覆盖南欧开局人口与建筑历史文件，以把原版克里特内容转交奥斯曼；可能与其他修改南欧开局人口或建筑的 mod 冲突。
- 本 mod 同名覆盖劳工组织、经济制度、土地改革和权力分配法律文件，以补全自定义法律的原版解锁链；可能与其他修改这些原版法律文件的 mod 冲突。
- 本 mod 覆盖主菜单与目标选择界面文件，以显示定制封面和第六个开局目标；可能与其他修改这些界面的 mod 冲突。
