...
- 新增下埃及可建造的大明版紫禁城奇观“应天府紫禁城”，图标、生产方式和效果复用北京紫禁城；统一后迁都南京时另有“南京紫禁城”可由玩家自行建造。下埃及首都另可建设教育奇观“四海国子监”，以较小的全国普通教育机会和下埃及农民教育、资质增长，换取建设、纸张和专业人口成本。
...
- 下埃及首都可建造“四海国子监”，但开局不直接建成。它需要 1200 建设量；满编时消耗 10 纸张，雇佣 500 学者、300 文员和 200 官僚，并按就业比例提供全国普通教育机会 `+1%`，以及仅限下埃及的农民教育机会 `+2%` 与人口资质增长 `+10%`。开始建设时下埃及必须仍为大明首都；建成后迁都不会令其失效。
...
- 新增 `building_mgn_imperial_academy`，本地化名“四海国子监”。它位于下埃及，仅能在下埃及仍为大明首都时开工；建成后即使迁都仍保留并运作，表现旧都继续承担非洲学术与吏员培养中心的职责。建筑建设量为 1200，满编消耗 10 纸张并雇佣 500 学者、300 文员和 200 官僚。第一轮实测发现原定全国农民教育机会 `+5%` 会在非洲庞大的农民人口上造成过快的识字率增长，因此最终拆为两个固定生产方式：`四方遣教（全国）` 按就业比例提供全国普通教育机会 `+1%`，`应天经世（下埃及）` 仅在下埃及提供农民教育机会 `+2%` 和人口资质增长 `+10%`。两者使用不同修正键，避免原版 UI 将全国与本地教育效果合并显示；全国值采用整数百分点，以符合原版该修正的零位小数显示精度。原版 1.13 的生产方式悬浮提示不会读取任意 `_desc` 文本，因此作用域直接写入两项生产方式名称，完整特色介绍保留在建筑说明中，不为此覆盖全局 GUI。第二轮实机检查已确认并接受当前 UI 表现，但尚未把长期识字率曲线视为完成验证。它不附加创新力、科研速度、权威、正统性、威望或产出加成，并与应天府紫禁城不互斥，使玩家在开局政治正统与人才培养之间承担真实的建设机会成本。
