...
For a public release, commit the intended source changes, merge the release PR, create a matching annotated tag such as `v0.1.2` from the merged default branch, push the tag, then attach the generated zip to the GitHub Release.
